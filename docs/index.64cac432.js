...
var O=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g;function L(e,t){return t?// U+0000 NULL becomes U+FFFD REPLACEMENT CHARACTER
"\x00"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e}E.escapeSelector=function(e){return(e+"").replace(O,L)},function(){var t,n,i,s,l,c,p,d,v,g,m=a,b=E.expando,x=0,w=0,T=ee(),S=ee(),O=ee(),L=ee(),M=function(e,t){return e===t&&(l=!0),0},q="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",// https://www.w3.org/TR/css-syntax-3/#ident-token-diagram
...
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+H+"))|)"+D+"*\\]",_=":("+H+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+P+")*)|.*)\\)|)",I=RegExp(D+"+","g"),R=RegExp("^"+D+"*,"+D+"*"),F=RegExp("^"+D+"*([>+~]|"+D+")"+D+"*"),W=RegExp(D+"|>"),$=new RegExp(_),B=RegExp("^"+H+"$"),z={ID:RegExp("^#("+H+")"),CLASS:RegExp("^\\.("+H+")"),TAG:RegExp("^("+H+"|[*])"),ATTR:RegExp("^"+P),PSEUDO:RegExp("^"+_),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+D+"*(even|odd|(([+-]|)(\\d*)n|)"+D+"*(?:([+-]|)"+D+"*(\\d+)|))"+D+"*\\)|)","i"),bool:RegExp("^(?:"+q+")$","i"),// For use in libraries implementing .is()
// We use this for POS matching in `select`
needsContext:RegExp("^"+D+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+D+"*((?:-\\d)?\\d*)"+D+"*\\)|)(?=[^-]|$)","i")},U=/^(?:input|select|textarea|button)$/i,X=/^h\d$/i,V=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Y=/[+~]/,// https://www.w3.org/TR/CSS21/syndata.html#escaped-characters
...
if(!L[e+" "]&&(!v||!v.test(e))){// qSA considers elements outside a scoping root when evaluating child or
...
(l=eu(e)).length;o--;)l[o]=(a?"#"+a:":scope")+" "+el(l[o]);f=l.join(",")}try{return m.apply(n,p.querySelectorAll(f)),n}catch(t){L(e,!0)}finally{a===b&&t.removeAttribute("id")}}}// All others
...
for(t in Z.matches=function(e,t){return Z(e,null,null,t)},Z.matchesSelector=function(e,t){if(es(e),d&&!L[t+" "]&&(!v||!v.test(t)))try{var n=g.call(e,t);// IE 9's matchesSelector returns false on disconnected nodes
if(n||h.disconnectedMatch||// As well, disconnected nodes are said to be in a document
// fragment in IE 9
e.document&&11!==e.document.nodeType)return n}catch(e){L(t,!0)}return Z(t,c,null,[e]).length>0},Z.contains=function(e,t){return(e.ownerDocument||e)!=c&&es(e),E.contains(e,t)},Z.attr=function(e,t){// Set document vars if needed
// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
...
cacheLength:50,createPseudo:et,match:z,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(e){return e[1]=e[1].replace(G,Q),// Move the given value to match[3] whether quoted or unquoted
...
e[4]=+(e[4]?e[5]+(e[6]||1):2*("even"===e[3]||"odd"===e[3])),e[5]=+(e[7]+e[8]||"odd"===e[3])):e[3]&&Z.error(e[0]),e)},PSEUDO:function(e){var t,n=!e[6]&&e[2];return z.CHILD.test(e[0])?null:(e[3]?e[2]=e[4]||e[5]||"":n&&$.test(n)&&// Get excess from tokenize (recursively)
...
header:function(e){return X.test(e.nodeName)},input:function(e){return U.test(e.nodeName)},button:function(e){return C(e,"input")&&"button"===e.type||C(e,"button")},text:function(e){var t;return C(e,"input")&&"text"===e.type&&// Support: IE <10 only
...
type:i[0].replace(N," ")}),a=a.slice(r.length)),n.filter)(i=z[s].exec(a))&&(!l[s]||(i=l[s](i)))&&(r=i.shift(),o.push({value:r,type:s,matches:i}),a=a.slice(r.length));if(!r)break}return(// Return the length of the invalid excess
...
c[o]=f,f[2]=e(t,n,u))return!0}}return!1}}function ef(e){return e.length>1?function(t,n,r){for(var i=e.length;i--;)if(!e[i](t,n,r))return!1;return!0}:e[0]}function ep(e,t,n,r,i){for(var o,s=[],a=0,u=e.length,l=null!=t;a<u;a++)(o=e[a])&&(!n||n(o,r,i))&&(s.push(o),l&&t.push(a));return s}function ed(e,t/* Internal Use Only */){var r,o,s,a,l=[],f=[],p=O[e+" "];if(!p){for(t||(t=eu(e)),a=t.length;a--;)(p=function e(t){for(var r,o,s,a=t.length,l=n.relative[t[0].type],c=l||n.relative[" "],f=l?1:0,p=ec(function(e){return e===r},c,!0),d=ec(function(e){return u.call(r,e)>-1},c,!0),h=[function(e,t,n){// Support: IE 11+, Edge 17 - 18+
// IE/Edge sometimes throw a "Permission denied" error when strict-comparing
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
...
(p=O(e,(r=l.length>0,o=f.length>0,s=function(e,t,s,a,u){var p,h,v,g=0,y="0",b=e&&[],w=[],T=i,S=e||o&&n.find.TAG("*",u),C=x+=null==T?1:Math.random()||.1,A=S.length;// Add elements passing elementMatchers directly to results
...
("object"==typeof e||"function"==typeof e)&&e.then)?i?l.call(e,s(o,n,z,i),s(o,n,U,i)):(// ...and disregard older resolution values
o++,l.call(e,s(o,n,z,i),s(o,n,U,i),s(o,n,z,n.notifyWith))):(r!==z&&(a=void 0,u=[e]),// Process the value(s)
// Default process is resolve
(i||n.resolveWith)(a,u))}},c=i?l:function(){try{l()}catch(e){E.Deferred.exceptionHook&&E.Deferred.exceptionHook(e,c.error),t+1>=o&&(r!==U&&(a=void 0,u=[e]),n.rejectWith(a,u))}};// Support: Promises/A+ section 2.3.3.3.1
...
n[0][3].add(s(0,e,v(i)?i:z,e.notifyWith)),// fulfilled_handlers.add( ... )
n[1][3].add(s(0,e,v(t)?t:z)),// rejected_handlers.add( ... )
n[2][3].add(s(0,e,v(r)?r:U))}).promise()},// Get a promise for this deferred
...
(e6=y.createElement("input")).setAttribute("type","radio"),e6.setAttribute("checked","checked"),e6.setAttribute("name","t"),e4.appendChild(e6),// Support: Android <=4.1 only
...
eO=/<script|<style|<link/i,eL=/checked\s*(?:[^=]|=\s*.checked.)/i,eM=/^\s*<!\[CDATA\[|\]\]>\s*$/g;// Prefer a tbody over its parent table for containing new rows
...
if(y||p>1&&"string"==typeof g&&!h.checkClone&&eL.test(g))return e.each(function(i){var o=e.eq(i);y&&(t[0]=g.call(this,i,o.html())),eI(o,t,n,r)});if(p&&(o=(i=eC(t,e[0].ownerDocument,!1,e,r)).firstChild,1===i.childNodes.length&&(i=o),o||r)){// Use the original fragment for the last item
...
if("string"==typeof e&&!eO.test(e)&&!ew[(eb.exec(e)||["",""])[1].toLowerCase()]){e=E.htmlPrefilter(e);try{for(;n<r;n++)t=this[n]||{},1===t.nodeType&&(E.cleanData(eT(t,!1)),t.innerHTML=e);t=0;// If using innerHTML throws an exception, use the fallback method
...
for(i in r=n.call(e),t)e.style[i]=o[i];return r},ez=RegExp(ec.join("|"),"i");function eU(e,t,n){var r,i,o,s,a=eW.test(t),// Retrieving style before computed somehow
...
(s=s.replace(N,"$1")||void 0),""!==s||ep(e)||(s=E.style(e,t)),!h.pixelBoxStyles()&&eF.test(s)&&ez.test(t)&&(// Remember the original values
...
var r=e$(e),i=(!h.boxSizingReliable()||n)&&"border-box"===E.css(e,"boxSizing",!1,r),o=i,s=eU(e,t,r),a="offset"+t[0].toUpperCase()+t.slice(1);// Support: Firefox <=54
...
var i,o,s,a=ee(t),u=eW.test(t),l=e.style;// Check if we're setting a value
...
(s=E.cssHooks[t]||E.cssHooks[a])&&"get"in s&&(i=s.get(e,!0,n)),void 0===i&&(i=eU(e,t,r)),"normal"===i&&t in eZ&&(i=eZ[t]),""===n||n)?(o=parseFloat(i),!0===n||isFinite(o)?o||0:i):i)}}),E.each(["height","width"],function(e,t){E.cssHooks[t]={get:function(e,n,r){if(n)// but it must have a current display style that would benefit
...
E.fx.step={};var e4,e6,e5,e9,e8=/^(?:toggle|show|hide)$/,e7=/queueHooks$/;// Animations created synchronously will run synchronously
...
delete u.elem}),u=function(){if(i)return!1;for(var t=e5||te(),n=Math.max(0,l.startTime+l.duration-t),r=1-(n/l.duration||0),o=0,s=l.tweens.length;o<s;o++)l.tweens[o].run(r);return(// If there's more to do, yield
(a.notifyWith(e,[l,r,n]),r<1&&s)?n:(s||a.notifyWith(e,[l,1,0]),// Resolve the animation and report its conclusion
a.resolveWith(e,[l]),!1))},l=a.promise({elem:e,props:E.extend({},t),opts:E.extend(!0,{specialEasing:{},easing:E.easing._default},n),originalProperties:t,originalOptions:n,startTime:e5||te(),duration:n.duration,tweens:[],createTween:function(t,n){var r=E.Tween(e,l.opts,t,n,l.opts.specialEasing[t]||l.opts.easing);return l.tweens.push(r),r},stop:function(t){var n=0,// otherwise we skip this part
...
return this.name&&!E(this).is(":disabled")&&tT.test(this.nodeName)&&!tw.test(e)&&(this.checked||!em.test(e))}).map(function(e,t){var n=E(this).val();return null==n?null:Array.isArray(n)?E.map(n,function(e){return{name:t.name,value:e.replace(tx,"\r\n")}}):{name:t.name,value:n.replace(tx,"\r\n")}}).get()}});var tE=/%20/g,tS=/#.*$/,tC=/([?&])_=[^&]*/,tk=/^(.*?):[ \t]*([^\r\n]*)$/mg,tA=/^(?:GET|HEAD)$/,tj=/^\/\//,/* Prefilters
	 ...
	 */tN={},tO="*/".concat("*"),tL=y.createElement("a");// Base "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
...
// Fixes trac-9887
function tH(e,t){var n,r,i=E.ajaxSettings.flatOptions||{};for(n in t)void 0!==t[n]&&((i[n]?e:r||(r={}))[n]=t[n]);return r&&E.extend(!0,e,r),e}tL.href=th.href,E.extend({// Counter for holding the number of active queries
...
S.setRequestHeader("Accept",d.dataTypes[0]&&d.accepts[d.dataTypes[0]]?d.accepts[d.dataTypes[0]]+("*"!==d.dataTypes[0]?", "+tO+"; q=0.01":""):d.accepts["*"]),d.headers)S.setRequestHeader(f,d.headers[f]);// Allow custom headers/mimetypes and early abort
...
return n=eU(e,t),eF.test(n)?E(e).position()[t]+"px":n})}),// Create innerHeight, innerWidth, height, width, outerHeight and outerWidth methods
...
!isNaN(e-parseFloat(e))},E.trim=function(e){return null==e?"":(e+"").replace(tF,"$1")},"function"==typeof define&&define.amd&&define("jquery",[],function(){return E});var tW=e.jQuery,t$=e.$;return E.noConflict=function(t){return e.$===E&&(e.$=t$),t&&e.jQuery===E&&(e.jQuery=tW),E},void 0===t&&(e.jQuery=e.$=E),E},"object"==typeof U?// is present, execute the factory and get jQuery.
// For environments that do not have a `window` with a `document`
// (such as Node.js), expose a factory as module.exports.
// This accentuates the need for the creation of a real `window`.
// e.g. var jQuery = require("jquery")(window);
// See ticket trac-14549 for more info.
U=o.document?s(o,!0):function(e){if(!e.document)throw Error("jQuery requires a window with a document");return s(e)}:s(o),function(){let e=new $,t="Not Started",n="Running...";e.configure({target:i.of(30,"seconds")}),e.events.subscribe("updated",e=>{X("#ex1 .clockTxt",t=z.duration(e.time))}),e.events.subscribe("finished",e=>{t=z.duration(e.time),n="FINISHED!",X("#ex1 .clockTxt",t),X("#ex1 .statusTxt",n)}),X("#ex1 .clockTxt",t),X("#ex1 .statusTxt",n),e.start()}(),function(){let e=new $,t=z.duration(e.state.time),n=e.state.phase.toLocaleUpperCase();e.configure({target:i.of(365,"days"),interval:i.of(100,"milliseconds")}),e.events.subscribe("started",e=>{X("#ex2 .phaseTxt",n=e.phase.toLocaleUpperCase())}),e.events.subscribe("paused",e=>{X("#ex2 .phaseTxt",n=e.phase.toLocaleUpperCase())}),e.events.subscribe("stopped",e=>{X("#ex2 .phaseTxt",n=e.phase.toLocaleUpperCase())}),e.events.subscribe("updated",e=>{X("#ex2 .clockTxt",t=z.duration(e.time,["minutes","seconds","milliseconds"]))}),V("#ex2 .startBtn",function(){e.start()}),V("#ex2 .pauseBtn",function(){e.pause()}),V("#ex2 .stopBtn",function(){e.stop()}),X("#ex2 .clockTxt",t),X("#ex2 .phaseTxt",n)}();//# sourceMappingURL=index.64cac432.js.map

//# sourceMappingURL=index.64cac432.js.map
