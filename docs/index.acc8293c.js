...
})({"2mIk0":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0f981062acc8293c";
"use strict";
...
},{}],"dvn4L":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _clockifyJs = require("../clockify.js");
// import { createApp, ref } from 'vue';
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
function writeToDom(selector, value) {
    (0, _jqueryDefault.default)(selector).html(value);
    (0, _jqueryDefault.default)(selector).html(value);
}
function onClick(selector, handler) {
    (0, _jqueryDefault.default)(selector).on("click", ()=>handler());
}
// #region jquery
// #region ex1
const ex1 = function() {
    const c = new (0, _clockifyJs.Clock)();
    let clockTxt = "Not Started";
    let statusTxt = "Running...";
    c.configure({
        target: (0, _clockifyJs.Duration).of(30, "seconds")
    });
    c.events.subscribe("updated", (state)=>{
        clockTxt = (0, _clockifyJs.Clockify).duration(state.time);
        writeToDom("#ex1 .clockTxt", clockTxt);
    });
    c.events.subscribe("finished", (state)=>{
        clockTxt = (0, _clockifyJs.Clockify).duration(state.time);
        statusTxt = "FINISHED!";
        writeToDom("#ex1 .clockTxt", clockTxt);
...
const ex2 = function() {
    const c = new (0, _clockifyJs.Clock)();
    let clockTxt = (0, _clockifyJs.Clockify).duration(c.state.time, [
        "minutes",
        "seconds",
        "milliseconds"
    ]);
    ...
    c.configure({
        target: (0, _clockifyJs.Duration).of(365, "days"),
        interval: (0, _clockifyJs.Duration).of(100, "milliseconds")
    });
    c.events.subscribe("started", (state)=>{
        phaseTxt = state.phase.toLocaleUpperCase();
        writeToDom("#ex2 .phaseTxt", phaseTxt);
    });
    c.events.subscribe("paused", (state)=>{
        phaseTxt = state.phase.toLocaleUpperCase();
        writeToDom("#ex2 .phaseTxt", phaseTxt);
    });
    c.events.subscribe("stopped", (state)=>{
        phaseTxt = state.phase.toLocaleUpperCase();
        writeToDom("#ex2 .phaseTxt", phaseTxt);
    });
    c.events.subscribe("updated", (state)=>{
...
const ex3 = function() {
    ...
    c.configure({
        mode: "countdown",
        initial: (0, _clockifyJs.Duration).of(5, "minutes"),
        interval: (0, _clockifyJs.Duration).of(100, "milliseconds")
    });
    c.events.subscribe("started", (state)=>{
        phaseTxt = state.phase.toLocaleUpperCase();
...
parcelHelpers.exportAll(_durationJs, exports);
var _clockUtilsJs = require("./clock-utils.js");

},{"./clock.js":"ltDw6","./duration.js":"9dH4z","./clock-utils.js":"luprm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ltDw6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Clock {
     ...
     */ constructor(configuration){
        ...
        this.currentTime = (0, _durationJs.Duration).of(0, "milliseconds");
        this.lastPollMs = performance.now();
        this.eventManager = new (0, _eventManagerJs.ClockEventManager)();
     ...
     */ configure(configuration) {
        if (this.isInLivePhase()) throw new Error(`Cannot configure a clock that is ${this.phase}.`);
        this.config = {
            ...DEFAULT_CONFIG,
            ...configuration
        };
     ...
     */ start() {
        ...
        if (this.isInHaltedPhase()) this.resetState();
        this.intervalId = setInterval(()=>this.update(), this.config.interval.in("milliseconds"));
        this.lastPollMs = performance.now();
        this.phase = "running";
     ...
     */ stop() {
        if (this.isInHaltedPhase()) return;
        if (this.phase === "running") clearInterval(this.intervalId);
        this.phase = "stopped";
    ...
    update() {
        const currentPollMs = performance.now();
        const elapsedMs = currentPollMs - this.lastPollMs;
        const newTimeMs = this.currentTime.in("milliseconds") + elapsedMs * this.directionMultiplier;
        this.currentTime = (0, _durationJs.Duration).of(newTimeMs, "milliseconds");
    ...
    isFinished() {
        if (this.config.mode === "countdown") return this.config.target.greaterThan(this.currentTime);
        else return this.config.target.lessThan(this.currentTime);
    }
    isInLivePhase() {
...
const DEFAULT_CONFIG = {
    mode: "stopwatch",
    interval: (0, _durationJs.Duration).of(500, "milliseconds"),
    target: (0, _durationJs.Duration).parse("0 seconds"),
    initial: (0, _durationJs.Duration).parse("0 seconds")
};

},{"./duration.js":"9dH4z","./event-manager.js":"i0yXL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9dH4z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const DURATION_REGEX = /^([0-9]+) *(days|hours|minutes|seconds|milliseconds{1}).*$/i;
class Duration {
    /**
     ...
     */ static parse(parseable) {
        try {
            const groups = (0, _utilsJs.Strings).unwrapMatch(parseable, DURATION_REGEX);
            if (!groups || groups.length !== 3) throw new Error(`String could not be split into count and unit`);
            const count = Number.parseInt(groups[1]);
            const unit = cookDurationUnit(groups[2]);
            return Duration.of(count, unit);
        } catch (e) {
            throw new Error(`Unable to parse ${parseable} as a Duration`, {
                cause: e
            });
        }
    }
     ...
     * @returns boolean
     */ greaterThan(other, orEqual) {
        if (orEqual) return this.valueInMillis >= other.in("milliseconds");
     ...
     * @param orEqual optional
     * @returns boolean
     */ lessThan(other, orEqual) {
        if (orEqual) return this.valueInMillis <= other.in("milliseconds");
        return this.valueInMillis < other.in("milliseconds");
    }
    flattenParamsToMillis(values) {
        let totalMillis = 0;
        if (values.days) totalMillis += values.days * MILLIS_PER_DAY;
        if (values.hours) totalMillis += values.hours * MILLIS_PER_HOUR;
        if (values.minutes) totalMillis += values.minutes * MILLIS_PER_MINUTE;
        if (values.seconds) totalMillis += values.seconds * MILLIS_PER_SECOND;
        if (values.milliseconds) totalMillis += Math.trunc(values.milliseconds);
        return totalMillis;
    }
}
function cookDurationUnit(raw) {
    switch(raw){
        case "days":
            return "days";
        case "hours":
...
},{"./utils.js":"jO57H","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jO57H":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Strings", ()=>Strings);
const Strings = {
    unwrapMatch (searchSpace, regex) {
        let cells = searchSpace.match(regex);
...
},{}],"i0yXL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ClockEventManager", ()=>ClockEventManager);
var _rxjs = require("rxjs");
class ClockEventManager {
    init() {
        this.updatedEvent = new (0, _rxjs.Subject);
        this.startedEvent = new (0, _rxjs.Subject);
        this.pausedEvent = new (0, _rxjs.Subject);
        this.stoppedEvent = new (0, _rxjs.Subject);
        this.finishedEvent = new (0, _rxjs.Subject);
    }
...
},{"./createErrorClass":"i1v8Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"luprm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Clockify", ()=>Clockify);
var _duration = require("./duration");
const Clockify = {
    duration (duration, includeUnits = [
        "minutes",
        "seconds"
    ], separator = ":") {
        return clockifyDuration(duration, includeUnits, separator);
    },
    durationParams (params, includeUnits = [
        "minutes",
        "seconds"
    ], separator = ":") {
        return this.duration(new (0, _duration.Duration)(params), includeUnits, separator);
    },
    seconds (seconds, includeUnits = [
        "minutes",
        "seconds"
    ], separator = ":") {
        return this.duration((0, _duration.Duration).of(seconds, "seconds"), includeUnits, separator);
    },
    milliseconds (millis, includeUnits = [
        "minutes",
        "seconds"
    ], separator = ":") {
        return this.duration((0, _duration.Duration).of(millis, "milliseconds"), includeUnits, separator);
    }
};
function clockifyDuration(duration, includeUnits = [
    "minutes",
    "seconds"
], separator = ":") {
    const values = duration.asValues();
    let parts = [];
    includeUnits.forEach((unit)=>{
        const currVal = values[unit];
        if (unit === "milliseconds") parts.push(String(currVal).padStart(3, "0"));
        else parts.push(currVal);
    });
    return parts.map((x)=>String(x).padStart(2, "0")).join(separator);
}

},{"./duration":"9dH4z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}]},["2mIk0","dvn4L"], "dvn4L", "parcelRequire3857")

//# sourceMappingURL=index.acc8293c.js.map
